...
const DropdownSearch: React.FC<DropdownProp> = ({ options, onSelect }) => {
      ...
      <div className="">
        <div className="relative inline-block">
          ...
          <div
            ...
            className={`absolute left-0 top-full z-40 mt-2 w-full rounded-md bg-white shadow-card dark:border-strokedark dark:bg-boxdark ${
          ...
          >
            ...
            {options.map((option, index) => (
              <li key={index}>
                <div
                  className="flex py-2 px-5 font-medium hover:bg-basicponint hover:text-basicWhite dark:hover:bg-meta-4 cursor-pointer"
