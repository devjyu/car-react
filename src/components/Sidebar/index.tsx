  ...
  return (
    <>
      ...
      <aside
        ...
        className={`${sidebarOpen ? 'open' : 'closed'} no-scrollbar h-screen bg-sidebarcolor text-basicWhite w-[200px] transition-all duration-300`}
      >
        ...
        <nav className="flex flex-col">
          <ul className='p-0 list-none'>
            ...
            <li>
              <NavLink
                to="/main"
                className={`flex item-center gap-2.5 rounded-sm text-basicWhite font-medium hover:bg-basicponint p-3.5 transition-colors duration-300 ${(pathname === '/main' || pathname.includes('dashboard')) && 'bg-basicponint'}`}
            ...
            <li>
              ...
              >
                ...
                <img src="/realtime.png" alt="" className='w-[22px] h-[22px]' />
                실시간 입/출차
              </NavLink>
            </li>
              ...
              {(handleClick, open) => {
                return (
                  <React.Fragment>
                    <NavLink
                      to="#"
                      className={`group relative flex item-center gap-2.5 rounded-sm text-basicWhite font-medium hover:bg-basicponint p-3.5 transition-colors duration-300 ${(pathname.includes('car')) && 'bg-basicponint'}`}
                      // className={
                    ...
                    >
                      ...
                      <img src="/car.png" alt="" className='w-[23px] h-[23px]' />
                      차량 관리
                      {/* </div> */}
                      {/* <div> */}
                      <svg
                    ...
                    >
                      <ul className="mt-3 mb-5 flex flex-col gap-2.5 pl-6">
                        {/* <li>
                                <NavLink
                                  reloadDocument
                                  to="/car-register"
              ...
              {(handleClick, open) => {
                return (
                  <React.Fragment>
                    <NavLink
                      to="#"
                      className={`group relative flex item-center gap-2.5 rounded-sm text-basicWhite font-medium hover:bg-basicponint p-3.5 transition-colors duration-300 ${(pathname.includes('/c/')) && 'bg-basicponint'}`}
                      // className={
                      //   `group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 
                    ...
                    >
                      ...
                      <img src="/inout.png" alt="" className='w-[23px] h-[23px]' />
                      입/출차 관리
                      <svg
                        className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                          }`}
