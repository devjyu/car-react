        ...
        <>
          <div className='mb-20'>
            ...
            <div className='grid grid-cols-3 gap-4'>
              ...
              <CardDataStats title="관리 차량 댓수/비관리 차량 댓수" total={`${dashboardData.vehicleCount.toString()} / ${dashboardData.apartmentVehicleCount} `} rate="">
              ...
              <CardDataStats title="금일 관리 차량 입차/출차 댓수" total={`${dashboardData.inCount} / ${dashboardData.outCount}`} rate="">
                {/* <CardDataStats title="금일 세대외 입차 수 / 출차 수" total={`${dashboardData.visitInCount.toString()} / ${dashboardData.visitOutCount.toString()}`} rate=""> */}
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#008080">
              ...
              <CardDataStats title="금일 비관리 차량 입차/출차 댓수" total={`${dashboardData.visitInCount.toString()} / ${dashboardData.visitOutCount.toString()}`} rate="">
